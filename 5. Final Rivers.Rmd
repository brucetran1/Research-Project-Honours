...
Read the csv --> 109 files --> match them with the position number in the folder (alphatbetical) and copy and paste the relevant files to a new folder for analysis. 