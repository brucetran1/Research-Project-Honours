...
obs_1990 <- read.csv("data/obs.summary2_1990.csv", header = TRUE)
obs_2000 <- read.csv("data/obs.summary2_2000.csv", header = TRUE)
...
tiff("paper/PCA_rivertype_wet.tif", width=480, height=480,
     compression = "lzw")
autoplot(obs1_1990pc, data = obs_1990, colour = "Type", size= 3, 
         loadings = TRUE, loadings.label = TRUE, loadings.label.size = 5) +
...
dev.off()
tiff("paper/PCA_rivertype_dry.tif", width=480, height=480,
     compression = "lzw")
autoplot(obs1_2000pc, data = obs_2000, colour = "Type", size=3,
         loadings = TRUE, loadings.label = TRUE, loadings.label.size = 5) + guides(show=FALSE) +
  theme_bw() + # removing gray background
  theme(panel.grid = element_blank()) + # removing background checkmarks
  theme(axis.text=element_text(size = rel(1.5)),
        axis.title=element_text(size=rel(2), face = "bold"),
