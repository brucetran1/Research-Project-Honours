...
On Floris suggestiong, I made a new category on the type of river of each catchment, based on the flows. This was done based on the proportion of time the river was flowing, within that time period. 
If the number of 0 flows is <= 1, it is perennial, otherwise it is ephemeral. 