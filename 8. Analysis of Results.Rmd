...
Removing the files that received "false convergence" or "function evaluation limit reached without".
...
Making a table for the results - the signatures
...
Code to create the signatures. 
Information was saved onto a csv file for later analysis.
Line 163 is relevant since I changed the formula later but I leave it there for reference - purpose is to convert the "Inf" values to NA because they'd be easier to analyse that way. 